...
export default function Dummy({ post }) {
  // Define formattedContent based on the post prop
  const formattedContent = post ? addSpacesBeforeH4AndParagraphs(post.content.rendered) : "";
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:max-w-4xl">
          ...
          <div className="mt-16 space-y-20 lg:mt-20 lg:space-y-20">
            {post && ( // Check if post is defined before rendering
              <article
                key={post.id}
